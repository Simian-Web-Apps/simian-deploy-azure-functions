...
if __name__ == "__main__":
    ...
    simian.local.Uiformio("hello_world", window_title="Simian: Hello DEFAULT World!")
    ...
    payload = {
        ...
        "navbar": {
            "title": (
                ...
                '<i class="fa fa-github"></i></a>&nbsp;Hello DEFAULT World - from Simian!'
            )
        },
    }

    html_hello = component.HtmlElement("html_hello", form)
    html_hello.content = "Hello DEFAULT World"
